...
@pytest.fixture(autouse=True)
def no_color(
    monkeypatch: MonkeyPatch, check_os_environ_stable: None
) -> None:  # noqa: PT004, U100
...
class ToxProject:
    ...
    def patch_execute(
        self, handle: Callable[[ExecuteRequest], int | None]
    ) -> MagicMock:
        ...
        result = self.mocker.patch.object(
...
def disable_pip_pypi_access(
    _invalid_index_fake_port: int, monkeypatch: MonkeyPatch
) -> tuple[str, str | None]:
