...
def run(argv):
    ...
    while True:
        ...
        try:
            ...
            ):  # pragma: no branch # python 2 does not support loading from bytearray
            ...
            print(
                "Backend: incorrect request to backend: {}".format(content),
                file=sys.stderr,
            )
            flush()
        else:
            ...
            try:
                ...
                try:
                    ...
                    print(
                        "Backend: Wrote response {} to {}".format(result, result_file)
                    )
                    flush()  # pragma: no branch
        if (
